...
public class P04_Robbery {
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (startingEnergy - shortestPath > 0) {
            sb.append(startingEnergy - shortestPath).append(System.lineSeparator());
        } else {
            sb.append("Busted - need ").append(shortestPath - startingEnergy)
                    .append(" more energy").append(System.lineSeparator());
        }
